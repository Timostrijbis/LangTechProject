...
def train_model(tokenized_dataset, tokenizer, access_token, model_path):
    ...
    training_args = TrainingArguments(
        output_dir="roberta_large_normal",
        learning_rate=2e-5,
        weight_decay=0.001,
        num_train_epochs=5,
        eval_strategy ="epoch",
    ...
    plt.savefig("results/roberta/normal/f1_scores_per_label.png")
    plt.close()
    ...
    plt.ylim(0, 1)
    plt.tight_layout()
    plt.savefig("results/roberta/normal/global_macro_micro_f1.png")
    plt.close()
...
def main():
    ...
    print("traing of model", model_path, "finished with normal data")
